...
public class JSONHelper {
    public static String MeetingToJSONinApp(Meeting meeting) throws JSONException {
    ...
    public static Meeting JSONToMeetinginApp(String json) throws Exception{
    ...
    public static long JSONToSync(String json) throws JSONException {
        JSONObject jsonobj = new JSONObject(json);
