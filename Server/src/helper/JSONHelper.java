...
public class JSONHelper {
	...
	public static LocalDateTime JSONToLastChange(String json) {
		JSONObject jsonobj = new JSONObject(json);
		return LocalDateTime.ofEpochSecond(jsonobj.getLong("lastChange"), 0, ZoneOffset.UTC);
	}

	public static String LastChangeToJSON(LocalDateTime localDateTime) {
		JSONObject jsonobj = new JSONObject();
		jsonobj.put("lastChange", localDateTime.toEpochSecond(ZoneOffset.UTC));
		return jsonobj.toString();
	}

	public static String StateToJSON(AgendaPoint agendaPoint) {
		JSONObject jsonobj = new JSONObject();
	...
	public static AgendaPoint JSONToState(String json) {
		AgendaPoint agendaPoint = new AgendaPoint();
	...
	public static long JSONToSync(String json) {
		JSONObject jsonobj = new JSONObject(json);
		return jsonobj.getLong("passedTime");
	}

	public static String SyncToJSON(long ticks) {
		JSONObject jsonobj = new JSONObject();
